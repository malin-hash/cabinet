  ...
  return (
    <div className="w-full bg-blue-100 rounded-md p-6 grid grid-cols-4 mt-12">
      <div className="flex-col text-center space-y-2">
        <p className="md:text-3xl text-lg text-blue-600 font-bold">100+</p>
      ...
      <div className="flex-col text-center space-y-2">
        <p className="md:text-3xl text-lg text-blue-600 font-bold">
          plus de {new Date().getFullYear() - 2017} ans
        </p>
