...
export default function Footer() {
  return (
    <div className="bg-blue-950 p-10 text-white rounded-t-3xl bottom-0 right-0 left-0">
      <div className="grid md:grid-cols-4 grid-cols-2 gap-5 mb-5">
        ...
        <div className="space-y-1">
          ...
          <div className="flex space-x-2">
            ...
            <p className="text-xs">
              Centre ville, 1er Arrondissement, Avenue D.Dacko
            </p>
          </div>
          <div className="flex space-x-2">
            <FaPhoneAlt size={15} />
          ...
          <div className="flex space-x-2">
            <FaEnvelope size={15} />
            <p className="text-xs">pabinguirufin@gmail</p>
          </div>
        </div>
        <div className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs">
              Consultations d'urgence disponibilité : 24h/7j
            </p>
          </div>
        </div>
      </div>
      ...
      <p className="text-center text-sm">
        © {new Date().getFullYear()} cabinet juridique PABINGUI & Associés. Tous
        droits réservés
      </p>
    </div>
  );
