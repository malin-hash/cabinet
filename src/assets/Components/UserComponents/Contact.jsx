    ...
    <div className="p-6 bg-blue-50">
      ...
      <div className="grid md:grid-cols-2 grid-cols-1 md:gap-3 gap-2">
        <div className="p-5 bg-white shadow-lg rounded-lg">
          {message && (
            <div className="m-1 p-3 w-full bg-green-300 text-black">
              {message}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div>
              ...
              >
                ...
                <option className="text-gray-500" value="Droit de l'immobilier">
                  Droit de l'immobilier
                </option>
                <option className="text-gray-500" value="Droit de la famille">
                  Droit de la famille
                </option>
              </select>
            </div>
            ...
            <button className="p-3 text-center w-full rounded-lg text-white bg-blue-700 hover:bg-blue-500 transition-colors duration-300">
              {loading ? "Chargement ..." : "Envoyez le message"}
            </button>
          </form>
        </div>
        <div className="p-5 bg-blue-600 text-white shadow-lg rounded-lg space-y-2">
          ...
          <div className="flex space-x-2">
            ...
            <div>
              ...
              <p className="text-xs ">
                Centre ville, 1er Arrondissement, Bangui
              </p>
            </div>
          </div>
          <div className="flex space-x-2">
          ...
          <div className="text-center text-white">
            ...
            <div className="flex  space-x-5 px-10">
              <FaAccessibleIcon />
              <p className="text-xs">
                Accessible en moto et voiture depuis tous les quartiers{" "}
              </p>
            </div>
          </div>
        </div>
