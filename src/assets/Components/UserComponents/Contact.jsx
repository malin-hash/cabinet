                ...
                <form>
                    ...
                    <div className='w-full'>
                        <div>
                            ...
                            <textarea name="" id="" cols="50"  className='w-full p-2 border-2 border-black rounded-lg resize-none' placeholder='Décrivez votre demande'></textarea>
                        </div>
                        <p className='text-sm text-gray-500'>0/500 caractères</p>
                    </div>
                    <button className='p-3 text-center w-full rounded-lg text-white bg-blue-700 hover:bg-blue-500 transition-colors duration-300'>Envoyez le message</button>
                </form>
            </div>
