...
export default function HomePage() {
  return (
    <div className="bg-[url('/blog-3.jpg')] bg-cover bg-center md:py-16 py-20  h-screen lg:px-20 md:px-10 px-8 bg-fixed ">
      ...
      <div className='grid lg:grid-cols-3 md:grid-cols-2  grid-cols-1 lg:gap-8 md:gap-4 gap-2 text-white'>
        ...
        <div className='p-6 bg-white/20 backdrop-blur-0 rounded-md md:block hidden text-center '>
            <div className='flex justify-center'>
