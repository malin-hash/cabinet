...
export default function HomePage() {
  return (
    <div className="bg-[url('/blog-3.jpg')] bg-cover bg-center md:py-16 py-20  h-screen lg:px-20 md:px-10 px-8 md:bg-fixed ">
      <h1 className="text-center text-white md:text-3xl text-2xl font-bold">
        Votre Cabinet de confiance
      </h1>
      <h1 className="text-center text-blue-600 md:text-4xl text-lg font-bold">
        PABINGUI & Associés
      </h1>
      <p className="text-center font-bold text-white md:text-md text-sm mb-6">
        Expertises juridiques <span className="text-xl text-blue-500">.</span>{" "}
        Conseil personnalisé <span className="text-xl text-blue-500"> .</span>{" "}
        Défense de vos droits
      </p>
      <div className="grid md:grid-cols-2 grid-cols-1 md:gap-4 gap-2 lg:px-40 md:px-20 px-2 mb-4">
        <Link
          to="rdv"
          smooth={true}
          duration={500}
      ...
      <div className="grid md:grid-cols-2  grid-cols-1 lg:gap-8 gap-2 text-white">
        <div className="p-6 bg-white/20 backdrop-blur-0 rounded-md text-center">
          ...
          <h1 className="text-xl font-bold text-center">
            {new Date().getFullYear() - 2017}+ Ans d'expérience
          </h1>
          <span className="text-center">
            Une expérience reconnue dans tous les domaines du droit
          </span>
        </div>
        <div className="p-6 bg-white/20 backdrop-blur-0 rounded-md text-center ">
          <div className="flex justify-center">
          ...
          <span className="text-center">
            Une relation de conficiance établie avec nos clients
          </span>
        </div>
      </div>
    </div>
