...
export default function Projects() {
    const equipes = [
        {id: 1, name: "Acquisition d'entreprise de 5.000.000.000 Fcfa", funtion: "Accord amiable obtenu", speciality: "Droit des affaire", experience: "Groupe industriel Sénégalais", content: "Accompagnement Complet d'une acquisition d'entreprise", avatar: "../../../../public/entre.jpg"},
        {id: 2, name: "Divorce complexe avec patrimoine internationnale", funtion: "transaction finalisée en 6 mois", speciality: "Droit de la famille", experience: "Couple d'entrepreneurs", content: "Expert en droit pénal avec une formation approfondie en criminologie et droit familial", avatar: "../../../../public/div.jpg"},
        {id: 3, name: "Défence Pénale en cour d'assises", funtion: "Acquitement total obtenu", speciality: "Droit pénal", experience: "Chef d'entreprise", content: "Spécialiste reconnu en transactions immobilières complexes et droit social", avatar: "../../../../public/blog-4.jpg"},
    ]
  return (
    <div className='px-24 bg-slate-100  py-5'>
